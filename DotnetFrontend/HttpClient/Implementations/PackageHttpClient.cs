...
namespace Client.Implementations
{
    public class PackageHttpClient : IPackageService
    {
        ...
        public async Task<SendPackageReturnDto> SendPackage(SendPackageDto dto)
        {
        ...
        public async Task<GetAllPackagesByUserDto> GetAllPackagesByUserId(string token)
        {
            ...
            GetAllPackagesByUserDto packages = JsonSerializer.Deserialize<GetAllPackagesByUserDto>(result,
