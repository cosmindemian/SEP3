...
public class LocationRpcService extends LocationServiceGrpc.LocationServiceImplBase {
    ...
    @Override
    public void deleteLocation(LocationServiceOuterClass.getLocationIdRpc request, StreamObserver<Empty> responseObserver) {
        try {
    ...
    @Override
    public void getAllLocations(Empty request,
    ...
    @Override
    public void getLocationWithAddressById(
    ...
    @Override
    public void getAllLocationsByType(
    ...
    @Override
    public void getAllLocationsByIdIn(
    ...
    @Override
    public void getAllLocationsWithAddressByIdIn(
            LocationServiceOuterClass.getLocationsIdInListRpc request,
    ...
    @Override
    public void getAllLocationsWithAddressByType(
            LocationServiceOuterClass.getTypeRpc request,
            StreamObserver<LocationServiceOuterClass.LocationsWithAddress> responseObserver) {
        try {
            ArrayList<Location> locations = locationService.getAllLocationsByType(request.getType());
